...
$config['tmst_supplier'] = $dbPrefix . 'tmst_supplier';
$config['tmst_supplier_address'] = $dbPrefix . 'tmst_supplier_address';
$config['tmst_supplier_pic'] = $dbPrefix . 'tmst_supplier_pic';
