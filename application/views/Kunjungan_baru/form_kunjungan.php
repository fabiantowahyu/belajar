                ...
                <div class="ibox-content">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <?php
                                                    echo form_dropdown('pasien', $option_pasien, '', 'id ="client_id" class="form-control" data-bv-notempty="true" style="width:100%"');
                                  ?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <?php
                                                    echo form_dropdown('dokter', $option_dokter, '', 'id ="client_id" class="form-control" data-bv-notempty="true" style="width:100%"');
                                                    ?>
                                                </div>
                                            </div>
