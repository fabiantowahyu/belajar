...
<div class="row-fluid">
    <legend>
        <h3>
            <?php
            echo anchor('report_lse_daglu', $title, array('class' => 'link-control'));
            ?><br/>
            <small> Rekapitulasi Penerbitan Laporan Surveyor Ekspor Batubara dan Produk Batubara </small>
        </h3>
        ...
        <div class="row">
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-custombutton="true" >
                    ...
                    <div>
                        <?php echo form_open('report_lse_daglu', array('name' => 'fmFilter', 'id' => 'fmFilter', 'class' => 'col-md-10 col-sm-12')); ?>
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover">
                                    <thead class="info">
                                        <tr>
                                            ...
                                            <th>Nomor ET Batubara</th>
                                            <th>Tanggal ET Batubara</th>
                                            <th>Negara Tujuan</th>
                                            <th>Nilai USD</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($results as $row) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row->no_reg_exporter; ?></td>
                                                <td><?php echo date("d F Y", strtotime($row->date_reg_exporter)); ?></td>
                                                <td><?php echo $row->country_name.', '.$row->port_destination; ?></td>
                                                <td><?php echo number_format($row->total_fas, 2); ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
