...
<div class="row-fluid">
    ...
    <h3>
        <?php 
        echo anchor('supplier', $title, array('class'=>'link-control')); 
        echo nbs(2);
        echo anchor('supplier/CTRL_New', '<i class="fa fa-plus"></i>', array('class'=>'btn btn-success btn-mini','data-rel'=>'tooltip',  'title'=>'Add Customer'));
        ?>
    </h3>
    </legend>
