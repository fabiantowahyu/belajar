                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <?php
                                                    $input = array('name' => 'cal_arb', 'value' => number_format($cal_arb, 2,',',','), 'placeholder' => "Cal.(KKal/Kg-arb)", 'class' => 'form-control cal_value', 'data-bv-notempty' => 'true', 'onkeypress'=>'return isNumberKey(event)');
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <?php
                                                    $input = array('name' => 'cal_adb', 'value' => number_format($cal_adb, 2,',',','), 'placeholder' => "Cal.(KKal/Kg-adb)", 'class' => 'form-control cal_value', 'data-bv-notempty' => 'true', 'onkeypress'=>'return isNumberKey(event)');
                                                    echo form_input($input);
                                                    ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <?php
                                                    $input = array('name' => 'tm_arb', 'value' => number_format($tm_arb, 2,',',','), 'placeholder' => "TM(%-arb)", 'class' => 'form-control cal_value', 'data-bv-notempty' => 'true', 'onkeypress'=>'return isNumberKey(event)');
                                                    echo form_input($input);
                                                    ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="" class="col-md-4 control-label" >T.Ash(%-arb)<span class="text-danger">*</span></label>
                                                <div class="col-md-6">
                                                    <?php
                                                    $input = array('name' => 't_ash_adb', 'value' => number_format($t_ash_adb, 2,',',','), 'placeholder' => "T.Ash(%-arb)", 'class' => 'form-control cal_value', 'data-bv-notempty' => 'true', 'onkeypress'=>'return isNumberKey(event)');
                                                    echo form_input($input);
                                                    ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <?php
                                                    $input = array('name' => 't_sulfur_adb', 'value' => number_format($t_sulfur_adb, 2,',',','), 'placeholder' => "T.Sulfur(%-adb)", 'class' => 'form-control cal_value', 'data-bv-notempty' => 'true', 'onkeypress'=>'return isNumberKey(event)');
                                                    echo form_input($input);
                                                    ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <?php
                                                    $input = array('name' => 'klasifikasi_batubara', 'value' => $klasifikasi_batubara, 'placeholder' => "Klasifikasi Barubara (adb)", 'class' => 'form-control', 'data-bv-notempty' => 'true');
                                                    echo form_input($input);
                                                    ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <?php
                                                    $input = array('name' => 'ket', 'value' => $ket, 'placeholder' => "Keterangan", 'class' => 'form-control', 'data-bv-notempty' => 'true');
                                                    echo form_input($input);
                                                    ?>
                                                </div>
                                            </div>
...
<input type="hidden" name="id" id="delid" value="<?php echo $id_cal; ?>">
<?php echo form_close(); ?>