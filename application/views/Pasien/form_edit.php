        ...
        <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                          <?php
                        $input = array('name' => 'foto','value'=>$poli, 'maxlength' => 64, 'id' => 'TypeName', 'class' => 'form-control', 'data-bv-notempty' => 'true');
                        echo form_input($input);
                        ?>
                    </div>
                </div>
...
<input type="hidden" name="id" id="delid" value="<?php echo $pasien; ?>">
<?php echo form_close(); ?>