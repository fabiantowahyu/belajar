...
-->
                    ...
                    <fieldset>
                        <legend>Provences</legend>
                        <div class="form-group">
                            <label for="ProvinceCode" class="col-md-2 control-label">Province Code</label>
                            <label class="control-label">: &nbsp;<?php echo $province_code; ?></label>
                        </div>
                        <div class="form-group">
                            <label for="ProvinceName" class="col-md-2 control-label">Province Name <span class="text-danger">*</span></label>
                            <div class="col-md-4">
                                <?php
                                $input = array('name'=>'province_name','maxlength'=>128,'id'=>'ProvinceName','class'=>'form-control','value'=>$province_name,'data-bv-notempty'=>'true');
