<div class="ibox-content">
    ...
    <div class="form-group">
        <label for="TypeName" class="col-md-2 control-label">Nama Item Reagent</label>
        <div class="col-md-4">
            <?php
            $input = array('name' => 'nama_produk', 'maxlength' => 64, 'id' => 'TypeName', 'class' => 'form-control', 'data-bv-notempty' => 'true');
    ...
    <div class="form-group">
        <label for="" class="col-md-2 control-label" >Satuan<span class="text-danger">*</span></label>
        <div class="col-md-4">
            <?php
            echo form_dropdown('satuan', $option_satuan, '', 'id ="client_id" class="form-control" data-bv-notempty="true" style="width:100%"');
            ?>
        </div>
    </div>
    ...
    <div class="col-md-12">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $no = 1;
                foreach ($results_consumable as $row) { ?>
                    ...
                    <tr>
                        ...
                        <td> <a class="btn btn-xs btn-danger" href="<?php echo base_url(); ?>tindakan_lab/deleteConsumable/<?php echo $row->id . '/' . $id_tindakan; ?>"><i class="fa fa-trash"></i></a></td>
                    </tr>
                    <?php
                }
                ?>
