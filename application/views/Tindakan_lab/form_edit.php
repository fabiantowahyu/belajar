            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php
                            echo form_dropdown('golongan', $option_golongan, $golongan, 'id ="client_id" class="form-control" data-bv-notempty="true" style="width:100%"');
                            ?>
                        </div>
                    </div>
                   
                    <div class="form-group">
                        <label for="" class="col-md-2 control-label" >Jenis<span class="text-danger">*</span></label>
                        <div class="col-md-4">
                            <?php
                            echo form_dropdown('jenis', $option_jenis, $jenis, 'id ="client_id" class="form-control" data-bv-notempty="true" style="width:100%"');
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php
                            $input = array('name' => 'tarif', 'value' => $tarif, 'placeholder' => 'Tarif', 'id' => 'TypeName', 'class' => 'form-control', 'data-bv-notempty' => 'true');
                            echo form_input($input);
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="TableName" class="col-md-2 control-label">Fee</label>
                        <div class="col-md-4">
                            <?php
                            $input = array('name' => 'fee', 'value' => $fee, 'placeholder' => 'Fee', 'id' => 'TypeName', 'class' => 'form-control', 'data-bv-notempty' => 'true');
                            echo form_input($input);
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="pull-right">
                            <div class="col-md-12">
                                ...
                                echo nbs(1);
                                echo form_hidden('id_tindakan_lab', $id_tindakan_lab);
                                ?>
...
<input type="hidden" name="id" id="delid" value="<?php echo $id_tindakan_lab; ?>">
<?php echo form_close(); ?>
