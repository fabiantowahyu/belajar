	...
	<div class="col-lg-12">
		...
		<div class="ibox-content">
		 ...
		 <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <?php
                        $input = array('name' => 'nama_dokter','value'=>$nama_dokter, 'maxlength' => 64, 'id' => 'TypeName', 'class' => 'form-control', 'data-bv-notempty' => 'true');
                        ...
                        <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <?php
                                                    echo form_dropdown('jabatan', $option_jabatan, $jabatan, 'id ="client_id" class="form-control" data-bv-notempty="true" style="width:100%"');
                                                    ?>
                                                </div>
                                            </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                          <?php
                        $input = array('name' => 'jadwal','value'=>$jadwal, 'maxlength' => 64, 'id' => 'TypeName', 'class' => 'form-control', 'data-bv-notempty' => 'true');
                        echo form_input($input);
                        ?>
                    </div>
                </div>
