...
<div class="row-fluid">
    ...
    <div class="row">
	    ...
	    <?php echo form_hidden('no_lse', $no_lse); ?>
            <header>
		<h3 class="text-info"><strong><center>LSE Certificate Information</center></strong></h3>
            </header>
	    <div class="col-md-12">
		...
		?>
			...
			<tbody>
			    ...
			    <tr>
				<td align="left" colspan="3" style="font-size: 10px;"><strong>A. KANTOR PENERBIT / <em>ISSUING OFFICE</em> : <?= $branch ?></strong></td>
			    </tr>
			    <tr>
		...
		<div class="form-actions">
			...
			<div class="col-md-12">
			    ...
			    <br/>
			    <?php
			    echo anchor('Lse_approval', '<i class = "fa fa-reply"></i>&nbsp;
				...
				if ($last_status == '3' || $last_status == '6' || $last_status == '7' || $last_status == '8') {
				    echo anchor('Lse_approval/CTRL_Print/' . $id_lse . '/' . $no_lse, '<i class = "fa fa-print"></i>&nbsp;
