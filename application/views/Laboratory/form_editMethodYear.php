...
<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');?>
    ...
    <div class="row-fluid">
        <div class="span8 offset2 panel-box">
            <div><h3>Edit Method Year</h3></div>
            <?php echo form_open($url,array('class'=>'form-horizontal','id'=>'validation-form-leader')); ?>

            <div class="hr"></div>

            <div class="control-group">
                <label for="StartDate" class="control-label">Year <span class="red bolder smaller">*</span></label>
                <div class="controls">
                    <?php
                    $input = array('name'=>'year', 'value'=>$year, 'id'=>'year','class'=>'input-mini input-mask-year');
