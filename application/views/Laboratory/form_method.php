...
<div class="row">
	<div class="span10 offset panel-box">
		...
		<fieldset>
			<div class="hr"></div>
			<div class="row-fluid">
				<div class="span6"><b>Not Test Method of : </b></div>
				<div class="span6"><b>Test Method of : </b></div>
			</div>
			<div class="row-fluid">
				<div class="span6">
					<div class="span9">
                        ...
                        <br /><br />
						<?php
							echo form_dropdown("selNonMember",$option_not_member,'','size="16" multiple="multiple" class="span9"');
						?>
					</div>
