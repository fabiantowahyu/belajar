...
-->
                        ...
                        <div class="tabbable" id="myTab">
                            <ul class="nav nav-tabs padding-16">
                                ...
                                <li id="tab-upload">
                                    <a data-toggle="tab" href="#edit-upload">
                                        <i class="blue icon-home bigger-125"></i>
                                        Upload
                                    </a>
                                </li>
                                ...
                                <fieldset>
                                    ...
                                    <div class="span6 offset panel-box1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <?php
                                                $input = array('name'=>'client','value'=>$client_name,'maxlength'=>32,'id'=>'ClientName','class'=>'form-control','data-bv-notempty'=>'true');
                        ...
                        <div id="edit-address" class="tab-pane">
                            ...
                            <div id="edit-upload" class="tab-pane">
                            <div class="space-10"></div>
                            <?php $this->load->view('Client/view_upload',$id); ?>
                        </div>
                    </div>
                </div>
            </div>
