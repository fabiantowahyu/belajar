...
<div class="row-fluid">
    <h3 class="header smaller lighter blue">
        ...
        echo 'PIC'; 
        echo nbs(2);
        echo anchor('client/CTRL_New_PIC/'.$id, '<i class="fa fa-plus"></i>', array('class'=>'btn btn-success btn-mini'));
        ?>
    </h3>
                            ...
                            <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="<?php echo base_url();?>client/CTRL_Edit_PIC/<?php echo $id;?>/<?php echo $row->id;?>" class="btn btn-xs btn-primary" ><i class="fa fa-edit bigger-120"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
