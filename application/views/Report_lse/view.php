...
<div class="row-fluid">
    <legend>
        <h3>
            <?php
            echo anchor('report_lse_tax', $title, array('class' => 'link-control'));
            ?><br/>
            <small>  Verifikasi Ekspor Produk Pertambangan tertentu </small>
        </h3>
        ...
        <div class="row">
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-custombutton="true" >
                    ...
                    <div>
                        <?php echo form_open('report_lse_tax', array('name' => 'fmFilter', 'id' => 'fmFilter', 'class' => 'col-md-10 col-sm-12')); ?>
