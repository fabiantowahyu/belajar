			...
			<div class="span9">
               ...
               <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php
							$input = array('name'=>'bank_branch','id'=>'bank_branch','class'=>'input-large');
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php
							$input = array('name'=>'bank_account','id'=>'bank_account','class'=>'input-large');
							echo form_input($input);
						?>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php
							$input = array('name'=>'account_name','id'=>'account_name','class'=>'input-large');
							echo form_input($input);
						?>
                    </div>
                </div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <?php
                            echo form_checkbox('isdefault',1,0,'class="ace-checkbox-2"');
                        ?>
                        <span class="lbl">&nbsp;</span>
                    </div>
                </div>	
