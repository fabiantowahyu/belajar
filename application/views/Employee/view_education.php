...
<div class="row-fluid">
	<h3 class="header smaller lighter blue">
		...
		echo 'Education'; 
		echo nbs(2);
		echo anchor('employee/CTRL_New_Education/'.$id, '<i class="icon-plus"></i>', array('class'=>'btn btn-warning btn-mini'));
		?>
	</h3>
	...
	<table id="table-education" class="table table-striped table-bordered table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td class="center">
					<?php 
						echo anchor('employee/CTRL_Edit_Education/' . $id . '/' . $row->id, '<button class="btn btn-mini btn-info"><i class="icon-edit bigger-120"></i></button>');
					?>
				</td>
			</tr>
			<?php } ?>
