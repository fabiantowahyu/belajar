...
?>>
    <head>
        ...
        <title> <?php echo $page_title != "" ? $page_title . " - " : ""; ?>Laporan Surveyor Coal - CARSURIN </title>
    ...
    <body class="smart-style-3 fixed-ribbon fixed-header" <?php
    echo implode(' ', array_map(function($prop, $value) {
                return $prop . '="' . $value . '"';
        ...
        if (!$no_main_header) {
            ...
            <header id="header">
                <div id="logo-group">
                    ...
                    <span id="logo"> <img src="<?php echo base_url(); ?>/file_upload/logo/logo_white.png" alt="Carsurin"> </span>
                    <!-- END LOGO PLACEHOLDER -->

                    <!-- Note: The activity badge color changes when clicked and resets the number to 0
                    Suggestion: You may want to set a flag when this happens to tick off all checked messages / notifications -->
                    <span id="activity" class="activity-dropdown"> <i class="fa fa-user"></i> <b  id="badge">   </b> </span>
                    ...
                    <div class="ajax-dropdown">
                        ...
                        <div class="btn-group btn-group-justified" data-toggle="buttons">
                            <!--                            <label class="btn btn-default">
                                                            <input type="radio" name="activity" id="<?php echo APP_URL; ?>/ajax/notify/reminder.php">
                                                            Reminder <span id="reminder">  </label>-->
                            <label class="btn btn-default sesuatu">

                                Notification <span id="notif"></span> </label>
                            <!--                            <label class="btn btn-default">
                                                            <input type="radio" name="activity" id="<?php echo APP_URL; ?>/ajax/notify/messages.php">
                                                            Messages <span id="messages"></span> </label>-->
                        </div> 
                        ...
                        <span >   <!-- footer: refresh area -->
                            <!--                         Last updated on: 12/12/2013 9:43AM-->
                            <button id="refresh" type="button" data-loading-text="<i class='fa fa-refresh fa-spin'></i> Loading..." class="btn btn-xs btn-default pull-right">
                ...
                <div class="project-context hidden-xs">
                    ...
                    <span class="label"><font size ="4">Laporan Surveyor - Export (Coal)</font></span>
                ...
                <div class="pull-right">
                    ...
                    <!-- input: search field -->
                     <form method="get" action="<?php echo base_url(); ?>admin/Ctrl_Search" class="header-search pull-right form_search">
                        <input type="text" name="param" placeholder="Global Search Transaction" id="search-fld">
                        <button type="submit">
                    ...
                    <ul class="header-dropdown-list hidden-xs">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
                                <img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-id" alt="Indonesia"> Indonesia</a>
                            <ul class="dropdown-menu pull-right">
                                <li class="active">
            ...
            <div id="shortcut">
                <ul>
                    ...
                    -->
                    <li>
                        <a href="<?php echo base_url(); ?>profile/" class="jarvismetro-tile big-cubes selected bg-color-blueLight"> <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>My Profile </span> </span> </a>
                    </li>
                </ul>
            </div>
            <!-- END SHORTCUT AREA -->
...
//$('#notification-info').text(' ini adalah text dito');
            ...
            function getCountNotification() {
                $.ajax({
                    url: "<?php echo base_url(); ?>admin/getCountNotification",
                    type: "GET",
                    dataType: "json",
            ...
            function getNotification() {
                $.ajax({
                    url: "<?php echo base_url(); ?>admin/getNotificationApproval",
                    type: "GET",
                    success: function (data) {
